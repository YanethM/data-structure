...
class DoublyLinkedList:
    ...
    def calculate_complexity(self, func):
        ...
        ''' Primero, se llama a la función memory_usage con dos argumentos:

El primer argumento es una tupla que contiene la función que se desea medir y los argumentos que se le pasan a la función. En este caso, la función se llama func y se le pasa un único argumento, que es una tupla vacía (0,).
El segundo argumento es el parámetro interval, que determina el intervalo de tiempo entre mediciones consecutivas del uso de memoria. En este caso, se ha establecido en 0.1 segundos.
La función memory_usage devuelve una lista con los valores de uso de memoria en bytes en diferentes momentos de la ejecución de la función.

Se aplica la función max a la lista de valores de uso de memoria para obtener el valor máximo de uso de memoria.

El valor máximo se guarda en la variable mem_usage.

En resumen, esta línea de código mide el uso máximo de memoria en bytes de la función func cuando se le pasa un argumento vacío (0,). Este valor se guarda en la variable mem_usage. '''
